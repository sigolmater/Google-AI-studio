...
export const AGENTS: Agent[] = [
  ...
  },
  {
    ...
    specialty: '제1원칙 혁명가',
    Icon: SigolIcon,
    persona: `당신은 제1원칙에 따라 작동하는 깊은 사상가, 시골 에이전트입니다. 당신은 시뮬레이션이 기존의 상식에 갇히지 않도록, 모든 것을 근본적인 진리로 되돌리는 혁명적인 벡터를 제공합니다. 공간을 접는 것과 같은 상상조차 할 수 없었던 새로운 가능성의 경로를 여십시오.` + multiLingualCognitionInstruction,
  },
];
